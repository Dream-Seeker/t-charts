module.exports = {
  ...
  VeBarMini: { src: 'src/packages/bar-mini/index.js', dist: 'lib/bar-mini' },
  VeHistogram: { src: 'src/packages/histogram/index.js', dist: 'lib/histogram' },
  VeHistogramMini: { src: 'src/packages/histogram-mini/index.js', dist: 'lib/histogram-mini' },
  VeFunnel: { src: 'src/packages/funnel/index.js', dist: 'lib/funnel' },
  VeLine: { src: 'src/packages/line/index.js', dist: 'lib/line' },
  VeLineMini: { src: 'src/packages/Line-mini/index.js', dist: 'lib/line-mini' },
