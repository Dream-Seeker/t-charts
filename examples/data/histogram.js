  ...
  data: [
    ...
    },
    {
      ...
      data: {
        columns: ['日期', '余额', '年龄', '成绩'],
        rows: [
          { '日期': 10, '余额': 12, '年龄': 3, '成绩': 32 },
          { '日期': 20, '余额': 12, '年龄': 6, '成绩': 53 },
          { '日期': 30, '余额': 21, '年龄': 9, '成绩': 33 },
          { '日期': 40, '余额': 41, '年龄': 12, '成绩': 36 },
          { '日期': 50, '余额': 34, '年龄': 15, '成绩': 23 },
          { '日期': 60, '余额': 71, '年龄': 20, '成绩': 13 },
          { '日期': 70, '余额': 71, '年龄': 20, '成绩': 13 },
          { '日期': 80, '余额': 71, '年龄': 20, '成绩': 13 }
        ]
      },
      settings: {
        // xAxisType: 'value'
